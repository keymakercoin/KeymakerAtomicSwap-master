...
var Keymaker_activehandle_output = ''; //Storing activehandle output this variable. accessible globally.
function Keymaker_activehandle() {    
    ...
    $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
            ...
            //console.log(AjaxOutputData);
            Keymaker_activehandle_output = AjaxOutputData;
            return true;
        },
        error: function(xhr, textStatus, error) {
            console.log('failed getting Coin History.');
    ...
    return 'Executed Keymaker_activehandle. Check Keymaker_activehandle_output var value.';
}

function Keymaker_Setactivehandle() {    
    ...
    $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
            ...
            sessionStorage.setItem('KeymakerActiveAccount', AjaxOutputDataToStore);
...
function Keymaker_addcoinLogin(addcoin_data) {
    //var addcoinValues = {"poll":100,"active":1,"agent":"keymaker","method":"addcoin","newcoin":addcoin_data.coin,"startpend":1,"endpend":1,"services":128,"maxpeers":16,"RELAY":addcoin_data.mode,"VALIDATE":addcoin_data.mode,"portp2p":addcoin_data.portp2p};
    ...
    if ( addcoin_data.coin == 'BTC' ) {
        ...
        var AddCoinData = {"prefetchlag":5,"poll":1,"active":1,"agent":"keymaker","method":"addcoin","newcoin":"BTC","startpend":64,"endpend":2,"services":128,"maxpeers":512,"RELAY":addcoin_data.mode,"VALIDATE":addcoin_data.mode,"portp2p":8333}
    ...
    if ( addcoin_data.coin == 'BTCD' ) {
        ...
        var logincoinmodeinfo = '';
        if ( addcoin_data.mode == '1' ) { logincoinmodeinfo = 'Full'; } else { logincoinmodeinfo = 'Basilisk'; }
        var AddCoinData = {"prefetchlag":-1,"poll":50,"active":1,"agent":"keymaker","method":"addcoin","newcoin":"BTCD","startpend":8,"endpend":4,"services":129,"maxpeers":64,"RELAY":addcoin_data.mode,"VALIDATE":addcoin_data.mode,"portp2p":14631,"rpc":14632}
        console.log(AddCoinData);
        console.log(logincoinfullname);
        console.log(logincoinmodeinfo);
    }
...
function Keymaker_addcoin(addcoin_data) {
    //var addcoinValues = {"poll":100,"active":1,"agent":"keymaker","method":"addcoin","newcoin":addcoin_data.coin,"startpend":1,"endpend":1,"services":128,"maxpeers":16,"RELAY":addcoin_data.mode,"VALIDATE":addcoin_data.mode,"portp2p":addcoin_data.portp2p};
    console.log(addcoin_data);
    if ( addcoin_data.coin == 'BTC' ) {
        var logincoinfullname = 'Bitcoin';
    ...
    if ( addcoin_data.coin == 'DOGE' ) {
        ...
        var logincoinmodeinfo = '';
        if ( addcoin_data.mode == '1' ) { logincoinmodeinfo = 'Full'; } else { logincoinmodeinfo = 'Basilisk'; }
        var AddCoinData = {"RELAY":addcoin_data.mode,"VALIDATE":addcoin_data.mode,"startpend":8,"endpend":4,"services":129,"auxpow":1,"prefetchlag":-1,"poll":10,"active":1,"agent":"keymaker","method":"addcoin","maxpeers":256,"newcoin":"DOGE","name":"Dogecoin","netmagic":"C0C0C0C0","p2p":22556,"rpc":22555,"pubval":30,"p2shval":5,"wifval":128,"txfee_satoshis":"100000000","minconfirms":2,"genesishash":"1a91e3dace36e2be3bf030a65679fe821aa1d6ef92e7c9902eb318182c355691","genesis":{"hashalgo": "scrypt","version":1,"timestamp":1386325540,"nBits":"1e0ffff0","nonce":99943,"merkle_root":"5b2a3f53f605d62c53e62932dac6925e3d74afa5a4b459745c36d42d0ed26a69"},"alertpubkey":"04d4da7a5dae4db797d9b0644d57a5cd50e05a70f36091cd62e2fc41c98ded06340be5a43a35e185690cd9cde5d72da8f6d065b499b06f51dcfba14aad859f443a"}
        console.log(AddCoinData);
        console.log(logincoinfullname);
        console.log(logincoinmodeinfo);
    }
...
function ExecuteAddCoinFn() {
    ...
    Keymaker_addcoin(ExecAddCoinData);
}

function Keymaker_ServiceUnavailable() {
    console.log('Network Error with history api');
    toastr.error("Unable to connect with keymaker service. 127.0.0.1:7778", "Service Notification")
    toastr.info("Are you sure Keymaker is running?", "Account Notification")
}